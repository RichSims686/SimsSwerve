...
public class DriveToPose extends CommandBase {
  ...
  public void execute() {
    ...
    Logger.getInstance().recordOutput("DriveToPose/DistanceSetpoint", driveController.getSetpoint().position);
    Logger.getInstance().recordOutput("DriveToPose/ThetaMeasured", currentPose.getRotation().getRadians());
    Logger.getInstance().recordOutput("DriveToPose/ThetaSetpoint", thetaController.getSetpoint().position);
    Logger.getInstance().recordOutput("Odometry/DriveToPoseSetpoint",
